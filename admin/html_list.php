...
if($_GET['Task']=="delete")
{
 $q=mysql_query("delete from `html` WHERE `HtmlID`='$HtmlID'")or die (mysql_error ());
...
?>
  ...
  <div class="site_performance_top"><span class="site_text">HTML </span> LIST     <div class="add_new"><a href="html_add.php"><img width="" height="" alt="" src="assets/image/add_new.png"></a></div>
 ...
 <div class="gallery_table">
	...
	<? if ($mssg!=""){  echo '<div class=submission_mssg>' .$mssg. '</div>' ; }?>
	 ...
	 <? $sql_page = "SELECT COUNT(*) as cnt FROM `html`";
...
<table cellspacing="0" border="0" cellpadding="4" width="100%" style="border-top:1px solid; border-bottom:1px solid; text-align:center" id="ctl00_ContentPlaceHolder1_GridView1" rules="all" class="gallery_table_list">
    ...
    $i=1;
$sql = "SELECT * FROM html order by HtmlID DESC LIMIT $offset ,$rowsperpage";
...
<td class=""><?php echo $row['SortIndex'];?></td>
				...
				<td><a href="html_add.php?HtmlID=<? echo $row['HtmlID']?>" style="text-align:center;"><img src="Assets/image/edit.png" /></a></td>
					<td><a href="html_list.php?HtmlID=<? echo $row['HtmlID'] ?>&Task=delete" onClick='return confirmSubmit()'><img src="Assets/image/delete.png" /></a></td>
	...
	<?
       ...
       if ($currentpage > 1) {
        // show << link to go back to page 1
         echo "<li><a href='{$_SERVER['PHP_SELF']}?currentpage=1&HtmlID=$HtmlID'>First</a></li>";
           // get previous page num
            $prevpage = $currentpage - 1;
             // show < link to go back to 1 page
              echo " <li><a href='{$_SERVER['PHP_SELF']}?currentpage=$prevpage&HtmlID=$HtmlID'><<</a></li> ";
              }
              ...
              for ($x = ($currentpage - $range); $x < (($currentpage + $range) + 1); $x++)
               ...
               if (($x > 0) && ($x <= $totalpages && $totalpages!=1)) {
                ...
                // if not current page...
                    ...
                    // make it a link
                    echo "<li><a href='{$_SERVER['PHP_SELF']}?currentpage=$x&HtmlID=$HtmlID'>$x</a></li>";
                        } // end else
                          } // end if
                           } // end for
...
echo "<li><a href='{$_SERVER['PHP_SELF']}?currentpage=$nextpage&HtmlID=$HtmlID'>>></a></li>";
                                                 // echo forward link for lastpage
         echo "<li><a href='{$_SERVER['PHP_SELF']}?currentpage=$totalpages&HtmlID=$HtmlID'>Last</a></li>";}
