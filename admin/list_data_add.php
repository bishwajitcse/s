...
<!--start content-->
 ...
 <form name="" class="cmxform" id="commentForm" action="Action/list_data_add1.php" method="post" enctype="multipart/form-data"> 

  <!--start form-->
      <div class="all_form">    
	  <?php
	     if($ListDataID!=""){
	   $sql = "SELECT * FROM `listdata` where ListDataID=$ListDataID";
...
?>
                        ...
                        CKEDITOR.replace( 'BigDetails' );
						  ...
						  <div class="controls">
						   ...
						   if ($ListDataID!="") { echo (" <img src=Upload/".$row[SmallImage]." width='100' height='70'/>"); } else {
						  ...
						  <div class="controls">
                            <input name="Submit" type="submit" value="Submit" class="submit" id="txtUser">
							  <input type="hidden" name="ListID" Value="<? echo $ListID ?>" />
							  	 <input type="hidden" name="ListDataID" Value="<? echo $ListDataID ?>" />
