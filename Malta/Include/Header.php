...
<head>
  <meta charset="utf-8">
  <title>SmartCity Malta - Welcome to SmartCity</title>
...
<header class="row">
  <div class="container">
    ...
    <h1 class="col-26">
      <a href="../index.html"><img src="../ui/media/dist/header/smartcity-logo-malta.png" /></a>
    </h1>
    ...
    <div class="col-70 pull-right">
      <div class="row small-nav">
        ...
        <ul class="top-buttons">
          ...
          <li><a href="index.php" class="malta active">SmartCity Malta</a></li>
          <li><a href="../Kochi/index.php" class="kochi">SmartCity Kochi</a></li>
        </ul>

      </div>
      <div class="row social-header">
        <ul class="pull-right">
          <li><span class="phone">+32 123 544 11</span></li>
          <li class="social">
...
<div class="row">
  <nav class="container">
   ...
   <?php /*?> <ul class="mobile-menu" id="menu">
      ...
      <li>
        <a href="about.html">About SmartCity Malta</a>
        <ul>
          <li><a href="about.html">Company Overview</a></li>
          <li><a href="mission-values.html">SCM Mission & Values</a></li>
          <li><a href="joint-ventures-partner.html">The Joint Ventures Parnter</a></li>
        </ul>
      </li>
      <li>
        <a href="advantage.html">SCM Advantage</a>
        <ul>
...
$sql = mysql_query("SELECT * FROM menu WHERE Parent_id=0 and CID=2") or die(mysql_error());
while($row = mysql_fetch_array($sql)){
   ?><li>

   
   <a href="<? echo $row['Template']; ?>.php?MenuID=<? echo $row['MenuID']; ?>"><? echo $row['Title'];?></a><? // echo main menu
